const i18n = {
  'en-US': {
    ...
    'menu.dashboard.assetManagement': 'Asset Management',
    'menu.dashboard.toolComponent': 'Tool Component',
    'menu.dashboard.workplace': 'Workplace',
    'menu.dashboard.agentFlow': 'Agent Flow',
    'menu.dashboard.workflowTemplate': 'Workflow Template',
  ...
  'zh-CN': {
    ...
    'menu.dashboard.assetManagement': '资产管理',
    'menu.dashboard.toolComponent': '工具组件',
    'menu.dashboard.workplace': '工作台',
    'menu.dashboard.agentFlow': 'Agent Flow',
    'menu.dashboard.workflowTemplate': '工作流模版',
    'navbar.logout': '退出登录',
    'settings.title': '页面配置',
